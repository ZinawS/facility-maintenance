...
function About() {
  ...
  useEffect(() => {
    apiService.getTeamMembers().then(setTeamMembers).catch(() => setTeamMembers([]));
  }, []);
      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <motion.section variants={sectionVariants} className="mb-16">
          ...
          {teamMembers.length === 0 ? (
            <EmptyState message="Team members coming soon." />
          ) : (
                ...
                >
                  <div className="h-60 bg-gray-100 overflow-hidden flex items-center justify-center">
                    {member.image_url ? (
                      ...
                      <UserRound className="w-16 h-16 text-primary/30" />
                    )}
                  </div>
